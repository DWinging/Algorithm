...
| 시간 제한 | 1 초 |
| 메모리 제한 | 128 MB |
| 알고리즘 | 비트마스킹, 다이나믹 프로그래밍, 비트필드를 이용한 다이나믹 프로그래밍, 외판원 순회 문제 |
| 링크 | [백준 바로가기](https://www.acmicpc.net/problem/2098) |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| 103708883 | ✅ 맞았습니다!! | 47412 KB | 172 ms | Java 8 / 수정 | 2026년 3월 10일 |
