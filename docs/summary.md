...
* **목표 개수에 따른 값 탐색:** 목표 개수를 만족하는 값을 찾는 것이 핵심
...
**🔗 기록:** [github](../Algorithm/2026/09/16/프로그래머스_선입_선출_스케줄링/)
...
* **차분 배열 트릭:** 금지 구간을 마킹하고 누적합으로 순차 탐색

**🔗 기록:** [github](../Algorithm/2026/09/12/Codeforces_Social_Distance/)
...
* **기준점 설정:** 탐색의 기준점을 취약점이 아닌 친구로 설정하는 것이 핵심

**🔗 기록:** [github](../Algorithm/2026/08/26/프로그래머스_외벽_점검/)
...
**🔗 기록:** [github](../Algorithm/2026/08/13/LeetCode_Maximum_Spending_After_Buying_Items/)
...
> 플랫폼: LeetCode <br>
> 알고리즘: 그래프 탐색, 0-1 BFS, 다익스트라

**💡 풀이 핵심(Core Logic):** 

* **방향 변경 체크:** 방향을 유지하면 가중치가 0, 방향을 변경하면 가중치가 1이다.

**🔗 기록:** [github](../Algorithm/2026/07/26/LeetCode_Minimum_Cost_to_Make_at_Least_One_Valid_Path_in_a_Grid/)
...
* **그리디 발상:** 그리디 발상은 어렵지 않지만, 조건이 많고 까다로워 실수하기 쉬운 문제.

**🔗 기록:** [github](../Algorithm/2026/06/18/SWEA_숫자_선물/)
...
* **두 포인터:** 합이 M이 되는 연속된 부분 수열 구하는 문제

**🔗 기록:** [github](../Algorithm/2026/06/10/SWEA_옥희의_OK!_부동산/)
...
**🔗 기록:** [github](../Algorithm/2026/05/31/SWEA_백화점/) | [velog](https://velog.io/@dong20/Java-SWEA-백화점)
...
* **규칙 찾기:** 카드를 뒤집는 과정은 연쇄 동작으로 이루어지게 됨. 따라서 연쇄 동작에 대한 규칙을 찾는 것이 핵심

**🔗 기록:** [github](../Algorithm/2026/05/29/SWEA_카드_뒤집기/)
