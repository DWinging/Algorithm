...
| 시간 제한 | 2 초 |
| 메모리 제한 | 512 MB |
| 알고리즘 | 자료 구조, 그래프 이론, 그래프 탐색, 트리, 집합과 맵, 해시를 사용한 집합과 맵 |
| 링크 | [백준 바로가기](https://www.acmicpc.net/problem/25601) |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| 104849708 | ✅ 맞았습니다!! | 73996 KB | 536 ms | Kotlin (JVM) / 수정 | 2026년 4월 8일 |
