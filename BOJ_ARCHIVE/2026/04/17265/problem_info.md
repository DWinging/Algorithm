...
| 시간 제한 | 1 초 |
| 메모리 제한 | 256 MB |
| 알고리즘 | 다이나믹 프로그래밍, 그래프 이론, 브루트포스 알고리즘, 그래프 탐색, 깊이 우선 탐색, 격자 그래프 |
| 링크 | [백준 바로가기](https://www.acmicpc.net/problem/17265) |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| 104902650 | ✅ 맞았습니다!! | 11460 KB | 64 ms | Java 8 / 수정 | 2026년 4월 10일 |
| 104902561 | ❌ 틀렸습니다 | - KB | - ms | Java 8 / 수정 | 2026년 4월 10일 |
